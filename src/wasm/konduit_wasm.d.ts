...
export class CardanoConnector {
  ...
  signAndSubmit(transaction: TransactionReadyForSigning, signing_key: Uint8Array): Promise<void>;
...
export interface InitOutput {
  ...
  readonly open: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: bigint, i: bigint) => any;
  readonly toVerificationKey: (a: number, b: number) => [number, number];
  readonly enableLogs: (a: number) => void;
  readonly close: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => any;
  ...
  readonly cardanoconnector_signAndSubmit: (a: number, b: number, c: number, d: number) => any;
  ...
  readonly outputassets_insert: (a: number, b: number, c: number, d: number, e: number, f: bigint) => void;
  ...
  readonly protocolparameters_withPlutusV3CostModel: (a: number, b: number, c: number) => number;
  readonly __wbg_transactionreadyforsigning_free: (a: number, b: number) => void;
  readonly transactionreadyforsigning_toString: (a: number) => [number, number];
  readonly wasm_bindgen__convert__closures_____invoke__he0b91bb628a575ae: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h6e058345d5cedd9d: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h07aec053534da3d8: (a: number, b: number, c: any, d: any) => void;
