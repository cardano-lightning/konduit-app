...
import { verificationKeyToAddress, verificationKeyToAddressBytes } from "../cardano/address.js";
  ...
  <div class="wallet-container" v-if="verificationKey !== null">
      ...
      <div id="address-section">
        ...
        <div>
          ...
          <Copy class="button" @click="copy($event)" data-label="key" :size="16" title="Copy address" />
          <a class="button" @click="openCardanoScan($event)" title="View on CardanoScan"><ExternalLink :size="16" /></a>
          <Share2 v-if="shareSupported" class="button" @click="shareAddress($event)" :size="16" title="Share address" />
          <QrCode class="button" @click="shareAddress($event)" :size="16" title="Share address" />
        </div>
